...
public class RaceViewModel extends AndroidViewModel {
  ...
  public void insert(Race race) {
    mRepository.insert(race);
  }

  public void updtae(Race race) {
    mRepository.update(race);
  }

  public void delete(Race race) {
    mRepository.delete(race);
  }
  ...
  public LiveData<List<Race>> getRacesByRaceIds(String eventKey, int[] raceIds) {
    return mRepository.getRacesByRaceIds(eventKey, raceIds);
  }
}
